    ...
    if (exports.OAuth == null) {
      exports.OAuth = {
        ...
        popup: function(provider, opts, callback) {
          ...
          wnd = window.open(url, "_blank", 'toolbar=yes,location=no,closebuttoncaption=Cancel,presentationstyle=fullscreen,toolbarposition=bottom,clearsessioncache=yes,clearcache=yes,transitionstyle=fliphorizontal');
